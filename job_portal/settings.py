...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'akhiiltkaniiparampiil@gmail.com' or os.getenv('EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Email host password
DEFAULT_FROM_EMAIL = 'akhiiltkaniiparampiil@gmail.com' or os.getenv('DEFAULT_FROM_EMAIL')
