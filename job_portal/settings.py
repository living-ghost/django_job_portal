...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'portal_user_app', 'static'),
    os.path.join(BASE_DIR, 'portal_admin_app', 'static'),
    os.path.join(BASE_DIR, 'portal_resume_app', 'static'),
